...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : eclipseware.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : eclipseware.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = eclipseware.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = eclipseware.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
